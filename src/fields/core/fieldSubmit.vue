<template lang="pug">
	input(:id="getFieldID(schema)", type="submit", :value="schema.buttonText", @click="onClick", :name="getFieldName(schema)", :disabled="disabled", :class="schema.fieldClasses", v-attributes="'input'")
</template>
